...
router.get('/user', (0, Auth_1.default)(globalInterface_1.ROLE_TYPE.Admin), user_Controller_1.AuthController.getAllUserController);
router.get('/user/:id', (0, Auth_1.default)(globalInterface_1.ROLE_TYPE.Admin), user_Controller_1.AuthController.getSingleController);
router.delete('/user/:id', (0, Auth_1.default)(globalInterface_1.ROLE_TYPE.Admin), user_Controller_1.AuthController.deleteUserController);
